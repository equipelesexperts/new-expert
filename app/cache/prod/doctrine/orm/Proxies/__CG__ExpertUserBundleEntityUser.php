...
namespace Proxies\__CG__\Expert\UserBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class User extends \Expert\UserBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', '' . "\0" . 'Expert\\UserBundle\\Entity\\User' . "\0" . 'nom', '' . "\0" . 'Expert\\UserBundle\\Entity\\User' . "\0" . 'prenom', '' . "\0" . 'Expert\\UserBundle\\Entity\\User' . "\0" . 'commentaires', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt');
        }
