...
namespace Proxies\__CG__\Expert\AdministrationBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Commentaire extends \Expert\AdministrationBundle\Entity\Commentaire implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Expert\\AdministrationBundle\\Entity\\Commentaire' . "\0" . 'id', '' . "\0" . 'Expert\\AdministrationBundle\\Entity\\Commentaire' . "\0" . 'contenu', '' . "\0" . 'Expert\\AdministrationBundle\\Entity\\Commentaire' . "\0" . 'datePublication', '' . "\0" . 'Expert\\AdministrationBundle\\Entity\\Commentaire' . "\0" . 'utilisateur');
        }
